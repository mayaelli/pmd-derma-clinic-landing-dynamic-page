...
export function TrustAndFaq() {
  ...
  return (
    <section
      id="about-faq"
      className="scroll-mt-20 bg-white py-20 border-b border-slate-200 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-sm space-y-6 relative">

            {/* Image Container with Fallback */}
            <div className="relative h-80 w-full rounded-2xl overflow-hidden bg-slate-50 border border-slate-200 flex items-center justify-center">
              {!imageError ? (
                <Image
                ...
                <div className="flex flex-col items-center justify-center text-center p-6 space-y-2">
                  ...
                  <span className="text-xs text-[#908A94]">Board-Certified Dermatologist</span>
                </div>
              )}
              ...
              <div className="absolute bottom-3 left-3 right-3 bg-white/90 backdrop-blur-md p-3 rounded-xl border border-white/80 shadow-xs flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-[#908A94]">Dermatology Specialist</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <h3 className="font-serif text-2xl font-bold text-[#2D2B30]">
                Dr. Precious
              </h3>
              <p className="font-sans text-sm text-slate-700 leading-relaxed">
            ...
            <div className="space-y-2.5 pt-3 border-t border-slate-200">
              ...
              <div className="flex items-center gap-2.5 text-xs text-[#333D29] font-medium">
                <ShieldCheck className="w-4 h-4 text-[#908A94] shrink-0" />
            ...
            <a
              href="#booking"
              className="w-full inline-flex items-center justify-center gap-2 bg-[#CD9581] hover:bg-[#B8846F] text-white text-xs font-semibold py-3.5 rounded-xl shadow-xs hover:shadow-md transition-all active:scale-98"
            >
          ...
          <div className="lg:col-span-7 space-y-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-[#908A94]">
              ...
              {faqs.map((faq, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <span className="font-serif text-sm md:text-base font-bold text-[#2D2B30]">
                        {faq.question}
                      </span>
                      <div
                        className={`w-7 h-7 rounded-full flex items-center justify-center shrink-0 transition-all duration-300 ${isOpen
                          ? "rotate-180 bg-[#CD9581] text-white"
                          : "bg-[#FAF7F2] text-[#2D2B30]"
                          }`}
                      >
                    ...
                    <AnimatePresence initial={false}>
                      {isOpen && (
                        ...
                        >
                          <div className="px-5 pb-5 pt-2 font-sans text-sm text-slate-700 leading-relaxed border-t border-slate-200">
                            {faq.answer}
                          </div>
                        </motion.div>
                      )}
