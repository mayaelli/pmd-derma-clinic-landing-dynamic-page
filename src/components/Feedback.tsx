...
const fallbackTestimonials: FeedbackItem[] = [
  {
    id: "fb-1",
    name: "Maria Santos",
    roleOrService: "Hydra Facial & Black Doll Combo",
    comment:
      "Dr. Precious is so gentle and thorough! My skin felt noticeably glowing and refreshed right after the first session. The clinic atmosphere is super relaxing and clean.",
    rating: 5,
    date: "2 weeks ago",
  },
  {
    id: "fb-2",
    name: "John Ray D.",
    roleOrService: "Underarm Sweatox",
    comment:
      "I was hesitant at first, but the results exceeded my expectations. Completely hassle-free procedure with almost no downtime. Highly recommended for dermatological concerns!",
    rating: 5,
    date: "1 month ago",
  },
  {
    id: "fb-3",
    name: "Clarissa V.",
    roleOrService: "Acne Scar Treatment",
    comment:
      "The board-certified expertise really shows. Dr. Precious crafted a custom regimen for my stubborn scars and I can finally see clear results after years of trying random products.",
    rating: 5,
    date: "3 weeks ago",
  },
  {
    id: "fb-4",
    name: "Elena R.",
    roleOrService: "Face Firming Meso",
    comment:
      "Professional staff, cozy ambiance, and visible skin improvement. The appointment scheduling was seamless too!",
    rating: 5,
    date: "2 months ago",
  },
];
...
export function Feedback({ initialFeedbacks = [] }: FeedbackProps) {
  const testimonials =
    initialFeedbacks && initialFeedbacks.length > 0
      ? initialFeedbacks
    ...
    <section id="feedback" className="scroll-mt-15 bg-white py-10 border-b border-[#E5BCA9]/30 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-xl mx-auto mb-4 space-y-2.5">
          <div className="inline-flex items-center gap-2 bg-white border border-[#E5BCA9]/50 text-[#C87D87] px-3.5 py-1 rounded-full text-xs font-sans font-semibold shadow-xs">
        ...
        {/* Hero Quote Card */}
        <div className="relative bg-white/80 backdrop-blur-md rounded-3xl p-8 sm:p-12 border border-[#E5BCA9]/40 shadow-lg">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            {/* Counter Badge */}
            <div className="text-xs font-sans font-semibold text-[#6B7556] bg-[#FAF7F2] px-3 py-1 rounded-full border border-[#E5BCA9]/30">
              ...
              <div className="pt-6 border-t border-[#E5BCA9]/30 flex flex-wrap items-center justify-between gap-4">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="inline-flex items-center gap-1 text-[10px] font-semibold text-[#6B7556] bg-[#FAF7F2] px-2 py-0.5 rounded-full border border-[#E5BCA9]/30">
                ...
                {current.date && (
                  <span className="text-xs text-[#525B44]/70 font-light">
                    {current.date}
                  </span>
                )}
              </div>
          ...
          <div className="absolute top-1/2 -left-5 sm:-left-6 -translate-y-1/2">
            <button
              onClick={handlePrev}
              className="w-11 h-11 rounded-full bg-white border border-[#E5BCA9]/50 text-[#333D29] hover:bg-[#6B7556] hover:text-white flex items-center justify-center transition-all shadow-md active:scale-95 cursor-pointer"
          ...
          {testimonials.map((t, idx) => (
            <button
              ...
              className={`h-2.5 rounded-full transition-all duration-300 cursor-pointer ${
                currentIndex === idx
                  ? "w-8 bg-[#6B7556]"
                  : "w-2.5 bg-[#E5BCA9]/50 hover:bg-[#C87D87]"
              }`}
